...
class selectionComm extends StatefulWidget {
  ...
  const selectionComm({Key? key, required this.onTap}) : super(key: key);
...
class _selectionCommState extends State<selectionComm> {
  ...
  Future addBookingDetails(String name, String phone, String address, String notes, DateTime newDate) async {
    await FirebaseFirestore.instance.collection('Commercial_bookings').add({
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text('Commercial Cleaning Service', textAlign: TextAlign.center,
