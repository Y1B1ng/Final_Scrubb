...
class updateUserRes extends StatefulWidget {
  final String documentId;

  updateUserRes({required this.documentId});

  @override
  _updateUserResState createState() => _updateUserResState();
}

class _updateUserResState extends State<updateUserRes> {
