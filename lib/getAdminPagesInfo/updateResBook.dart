...
class updateResBook extends StatefulWidget {
  final String documentId;

  updateResBook({required this.documentId});

  @override
  _updateResBookState createState() => _updateResBookState();
}

class _updateResBookState extends State<updateResBook> {
