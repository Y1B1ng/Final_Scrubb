...
class updateHouseBook extends StatefulWidget {
  final String documentId;

  updateHouseBook({required this.documentId});

  @override
  _updateHouseBookState createState() => _updateHouseBookState();
}

class _updateHouseBookState extends State<updateHouseBook> {
